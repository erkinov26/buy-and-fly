...
import { YandexMetrika } from '../../core/metrics/yandex.metrika';
import { GoogleAnalytics } from '../../core/metrics/google-analytics';
...
export function extractOptions(options?: MetricOptions): {
  readonly ym?: Record<string, unknown>;
  readonly ga?: Record<string, unknown>;
} {
  let { ym, ga } = options ?? {};
